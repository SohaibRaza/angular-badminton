...
/* harmony import */ var _components_kids_academy_content_kids_academy_content_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/kids-academy-content/kids-academy-content.component */ "./src/app/components/kids-academy-content/kids-academy-content.component.ts");
/* harmony import */ var _components_kids_academy_kids_academy_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/kids-academy/kids-academy.component */ "./src/app/components/kids-academy/kids-academy.component.ts");
/* harmony import */ var _components_login_login_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/login/login.component */ "./src/app/components/login/login.component.ts");
/* harmony import */ var _components_mental_content_mental_content_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/mental-content/mental-content.component */ "./src/app/components/mental-content/mental-content.component.ts");
/* harmony import */ var _components_mental_courses_mental_courses_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/mental-courses/mental-courses.component */ "./src/app/components/mental-courses/mental-courses.component.ts");
/* harmony import */ var _components_physical_content_physical_content_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/physical-content/physical-content.component */ "./src/app/components/physical-content/physical-content.component.ts");
/* harmony import */ var _components_physical_programs_physical_programs_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/physical-programs/physical-programs.component */ "./src/app/components/physical-programs/physical-programs.component.ts");
/* harmony import */ var _components_plans_plans_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/plans/plans.component */ "./src/app/components/plans/plans.component.ts");
/* harmony import */ var _components_podcast_content_podcast_content_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/podcast-content/podcast-content.component */ "./src/app/components/podcast-content/podcast-content.component.ts");
/* harmony import */ var _components_podcasts_podcasts_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/podcasts/podcasts.component */ "./src/app/components/podcasts/podcasts.component.ts");
...
/* harmony import */ var _components_tactical_lesson_content_tactical_lesson_content_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/tactical-lesson-content/tactical-lesson-content.component */ "./src/app/components/tactical-lesson-content/tactical-lesson-content.component.ts");
/* harmony import */ var _components_tactical_lessons_tactical_lessons_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/tactical-lessons/tactical-lessons.component */ "./src/app/components/tactical-lessons/tactical-lessons.component.ts");
/* harmony import */ var _components_training_program_content_training_program_content_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/training-program-content/training-program-content.component */ "./src/app/components/training-program-content/training-program-content.component.ts");
/* harmony import */ var _components_training_programs_training_programs_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/training-programs/training-programs.component */ "./src/app/components/training-programs/training-programs.component.ts");
/* harmony import */ var _components_tutorials_tutorials_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/tutorials/tutorials.component */ "./src/app/components/tutorials/tutorials.component.ts");
/* harmony import */ var _components_whats_new_whats_new_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/whats-new/whats-new.component */ "./src/app/components/whats-new/whats-new.component.ts");
...
let BrowseComponent = class BrowseComponent {
    ...
    initPages() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            // this.initMainContent();
            // await this.initTacticalLessons();
            // await this.initTrainingPrograms();
            // await this.initMentalCourse();
            // await this.initPodcast();
            // this.initArticles();
            // this.initTutorials();
            // await this.initPhysical();
            // this.initSliderContent();
            // await this.initKidsAcademies();
        });
    }
    initMainContent() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
let SettingsComponent = class SettingsComponent {
    ...
    loadFromCache() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            // this.notificationsEnabled = !!window.localStorage.getItem('notificationsEnabled');
            // this.scanAuthEnabled = !!window.localStorage.getItem('scanAuthEnabled');
...
/* harmony import */ var _training_plans_popover_training_plans_popover_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../training-plans-popover/training-plans-popover.component */ "./src/app/components/training-plans-popover/training-plans-popover.component.ts");
...
let VideoWrapperComponent = class VideoWrapperComponent {
    constructor(favoritesService, popoverController, vimeoService) {
        this.favoritesService = favoritesService;
...
let VimeoService = class VimeoService {
    ...
    download(id) {
        return new Promise((resolve, reject) => {
            this.getWithHeaders(`${id}`).subscribe((event) => {
    ...
    getAndDownload(id) {
        return new Promise((resolve, reject) => {
            this.getWithHeaders(`${this.url}/${id}`)
                ...
                const files = event.download.sort((a, b) => a.size - b.size);
                console.log(files);
                const blob = yield this.download(files[files.length - 1].link);
            }), err => {
                console.log(err);
                reject(err);
            });
